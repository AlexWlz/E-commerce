...
function Mentions() {
  return (
    <div className="mentions conteneur_card">
      <div className="card">
        ...
        <p>
          ...
          visiteurs du site :{" "}
          <a href="http://snikerz.fr" target="_blank">
            snikerz.fr
          </a>{" "}
        ...
        <p>
          ...
          <strong> Snikerz</strong>, qui l'édite.
        </p>

        <p>
          <strong> Snikerz SARL </strong>au capital de
          <strong> 1</strong>€ Tél : <strong>01 02 03 04 05</strong>
        </p>

        <p>
          <strong>25 Rue Claude Tillier</strong>
          <strong>75012 Paris</strong>
          <br />
          Immatriculée au Registre du Commerce et des Sociétés de
          <strong>1234 </strong>sous le numéro
          <strong>123456789</strong>
        </p>

        <p>
          Numéro TVA intracommunautaire : <strong>123</strong>
          <br />
          Adresse de courrier électronique :{" "}
          <strong>wallezalexis@gmail.com</strong>
          <br />
          <br />
          Directeur de la publication : <strong>Olivier Test</strong>
          <br />
        ...
        <p>
          ...
          <strong>test 25 Rue Claude Tillier 75012 Paris</strong>
          <br />
          <u>
        ...
        <p>
          ...
          sauf autorisation écrite préalable à l'email : wallezalexis@gmail.com.
